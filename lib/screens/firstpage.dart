...
class _HomeState extends State<Home> {
  ...
  void initState() {
    ...
    setState(() {
      ...
      hoursdiff = DateTime.now().difference(DateTime.parse(date!)).inHours;
      ...
      if (issmoking == 1) {
        ...
        if (dayswithoutsmoking == 0) {
          ...
          UserPrefs.setHoursWithoutSmoking(hoursdiff!);
        }
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        LinearPercentIndicator(
                          ...
                          animation: true,
                          percent: UserPrefs.getminWithoutSmoking()! >= 20
                              ? 1
                              : UserPrefs.getminWithoutSmoking()! / 20,
                        ),
                        const SizedBox(height: 10),
                      ],
                    ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        LinearPercentIndicator(
                          ...
                          animationDuration: 1500,
                          animation: true,
                          percent: UserPrefs.getDaysWithoutSmoking()! >= 90
                              ? 1
                              : UserPrefs.getDaysWithoutSmoking()! / 90,
                        ),
                        const SizedBox(height: 10),
                      ],
                    ),
